({
	validationcheck : function(component, event, helper) {
        ...
        var isValid = true;
        if(component.get("v.parentAccount").Name == undefined ){
    ...
    resetdata : function(component, event, helper) {
        var acc = component.get("v.parentAccount");
        acc.Id = "";
        acc.Name = "";
        
        var loc = component.get("v.searchLocation");
        loc.Id = "";
        loc.Name = "";
        
        var objloc = component.get("v.objLocation");
        objloc.Id = "";
        objloc.Name = "";
        objloc.UNCode__c = "";
